...
this code find outline of tiles that includes center(240,320).
and it prints every x coordinate and y coordinate of outline. ( variable that coordinate is saved : x --> contour_x, y --> contour_y )
so you can uses x / y coordinate of outline of tile that includes center using ( contour_x, contour_y )

additinally time variable in this code is only for caculate time, so it's not super necessary 
'''


#don't know why, but gpt says so...
import torch, re
...
from coord_change import coord_change
